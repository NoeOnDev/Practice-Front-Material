  ...
  const handleCancelClick = async () => {
    ...
    if (confirm("¿Estás seguro de cancelar esta cita?")) {
      try {
        ...
        // Mostrar snackbar después de cancelar con éxito
        showSnackbar && showSnackbar("Cita cancelada correctamente", "success");
        ...
        showSnackbar && showSnackbar("Error al cancelar la cita", "error");
